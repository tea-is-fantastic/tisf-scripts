...
dirs.react_native = path.join(dirs.src, 'mobile');

dirs.rn_android = path.join(dirs.react_native, 'android');
dirs.rn_android_src = path.join(dirs.rn_android, 'app', 'src', 'main');
dirs.rn_src = path.join(dirs.react_native, 'src')
dirs.rn_assets = path.join(dirs.react_native, 'assets')
